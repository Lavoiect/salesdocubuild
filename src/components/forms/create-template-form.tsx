'use client'
import { saveActivityLogsNotification, upsertDocument, upsertTemplate, upsertWorkspace } from "@/lib/queries";
...
const CreateTemplateForm: React.FC<CreateTemplateProps> = ({
    defaultData,
    agencyId
}) => {
